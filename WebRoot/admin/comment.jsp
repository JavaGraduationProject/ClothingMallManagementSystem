         ...
         <div class="lefterbox">
          ...
          <div class="main">
            <div id="shopping">
                   ...
                   <table>
                     <tr><th>评价ID</th><th>订单详情ID</th><th>评价内容</th><th>评价商品</th><th>用户名</th></tr>
			   ...
			   <div class="pager">    
                   ...
                   <li><a href="CommentShowServlet?cp=1">首页</a>
                   <li><a href="CommentShowServlet?cp=${cpage-1<=0 ?1:cpage-1}">上一页</a></li>
                   <li><a href="CommentShowServlet?cp=${cpage+1>=tpage ? tpage : cpage+1 }">下一页</a></li>
                   <li><a href="CommentShowServlet?cp=${tpage }">尾页</a></li>
                   <li>
