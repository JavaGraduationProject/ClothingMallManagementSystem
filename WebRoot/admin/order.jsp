         ...
         <div class="lefterbox">
          ...
          <div class="main">
            <div id="shopping">
                   ...
                   <table>
                     <tr><th>订单ID</th><th>订单用户</th><th>收货地址</th><th>操作</th></tr>
                     <c:forEach var="o" items="${orderlist}">
					    <tr align="center"> 
						  <td>${o.oid}</td>
						  <td>${o.username}</td>
						  <td>${o.useradress}</td>
						  <td class="delete"><a href="OrderDetailShowServlet?o=${o.oid}">查看详情</td>
					    </tr>
					  </c:forEach>
			       ...
			       <div class="pager">
			            <ul class="clearfix"> 
			               <li> 当前:${cpage}/${tpage}</li>
			               <li><a href="OrderShowServlet?cp=1">首页</a></li>
			               <li><a href="OrderShowServlet?cp=${cpage-1<=0 ?1:cpage-1}">上一页</a></li>
                           <li><a href="OrderShowServlet?cp=${cpage+1>=tpage ? tpage : cpage+1 }">下一页</a></li>
			               <li> <a href="OrderShowServlet?cp=${tpage }">尾页</a></li>
			               <li>
			               <select onchange="jump(this.value)"></li>
