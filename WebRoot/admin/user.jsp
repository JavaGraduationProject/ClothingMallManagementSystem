		...
		<div class="banner">
         <div class="lefterbox">
          ...
          <div class="main">
            <div id="shopping">
                   <table>
                     <tr><th>用户ID</th><th>用户名</th><th>性别</th><th>手机</th><th>收货地址</th><th>邮箱</th></tr>
			   ...
			   <div class="pager">   
			   <ul class="clearfix">  
			       <li>当前:${cpage}/${tpage}页<a href="UserShowServlet?cp=1">首页</a></li>
			       <li><a href="UserShowServlet?cp=${cpage-1<=0 ?1:cpage-1}">上一页</a></li>
               <li><a href="UserShowServlet?cp=${cpage+1>=tpage ? tpage : cpage+1 }">下一页</a></li>
			   <li><a href="UserShowServlet?cp=${tpage }">尾页</a></li>
