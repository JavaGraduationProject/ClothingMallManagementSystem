...
public class FinshGoodsServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public FinshGoodsServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		int num=OrderDetailDao.finshGoods(otid);
		
		if(num>0){
			PrintWriter out = response.getWriter();
			out.print("<script>");
			out.print("alert('更新成功');");
			out.print("location.href='SelectOrderServlet';");
			out.print("</script>");
			out.close();
		}else{
