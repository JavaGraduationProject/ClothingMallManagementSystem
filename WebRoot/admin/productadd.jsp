			...
			<form action="ProductAddServlet" method="post" enctype="multipart/form-data">
				<table class="form">
					...
					<tr>
						...
						<td><input type="text" class="text" name="prodetail" /></td>
					</tr>
					<tr>
						<td class="field">商品价格：</td>
						<td><input type="text" class="text" name="proprice" /></td>
					</tr>
					<tr>
						<td class="field">商品库存：</td>
						<td><input type="text" class="text" name="prostock" /></td>
					</tr>
					<tr>
						<td class="field">类目：</td>
						<td>
							<select name="cateid">
