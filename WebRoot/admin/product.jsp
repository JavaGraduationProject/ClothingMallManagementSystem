	...
	<div id="suber">
		...
		<div class="banner">
         <div class="lefterbox">
          ...
          <div class="main">
            <div id="shopping">
            <div class="adda"><a href="AddProductShowServlet">新增</a></div>
                   <table>
                     <tr><th>商品ID</th><th>商品名称</th><th>类目</th><th>操作</th></tr>
                     <c:forEach var="pro" items="${productlist}">
					    <tr align="center"> 
						  ...
						  <c:forEach var="c" items="${clist}">
						     <c:if test="${pro.cateid==c.cateid}">
			                    ${c.catename}
			                 </c:if>
			              </c:forEach>
			              </td>
						  <td class="delete"><a href="ProDetailShowServlet?proid=${pro.proid}">修改</a> &nbsp;<a href="DProductServlet?proid=${pro.proid}">删除</td>
					    </tr>
					  </c:forEach>
			    ...
			    <div class="pager">  
			    <ul class="clearfix">   
			      <li> 当前:${cpage}/${tpage}页<a href="ProductShowServlet?cp=1">首页</a></li>
			      <li><a href="ProductShowServlet?cp=${cpage-1<=0 ?1:cpage-1}">上一页</a></li>
               <li><a href="ProductShowServlet?cp=${cpage+1>=tpage ? tpage : cpage+1 }">下一页</a></li>
			  <li> <a href="ProductShowServlet?cp=${tpage }">尾页</a></li>
